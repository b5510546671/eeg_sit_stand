...
class EEGNet(nn.Module):
    ...
    def __init__(self, n_channel, n_timepoint, n_class=2,
    ...
    def cal_flat_size(self, model):
        ...
        '''
        data = torch.rand(1,1,self.n_channel, self.n_timepoint)
        model.eval()
    ...
    def __repr__(self):
        return "EEGNet(n_channel={}, n_timepoint={}, n_class={}, dropout={}, F1={}, D={}, C1={})".format(self.n_channel, self.n_timepoint, self.n_class, self.dropout, self.F1, self.D, self.C1)